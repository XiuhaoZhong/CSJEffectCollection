...
GraphicModel::GraphicModel(std::string modelFilePath) {
    GraphicModelImporter modelImporter = GraphicModelImporter();
...
int GraphicModel::getNumVertices() {
    return m_iNumVertices;
}

std::vector<glm::vec3> GraphicModel::getVertices() {
    return m_vVertices;
}

std::vector<glm::vec2> GraphicModel::getTexCoords() {
    return m_vTexCoords;
}

std::vector<glm::vec3> GraphicModel::getNormals() {
    return m_vNormals;
}

void GraphicModelImporter::parseOBJFile(std::string& filePath) {
    float x, y, z;
    string content;
...
int GraphicModelImporter::getNumVertices() {
    return m_vTriangleVerts.size() / 3;
}

std::vector<float> GraphicModelImporter::getVertices() {
    return m_vTriangleVerts;
}

std::vector<float> GraphicModelImporter::getTexCoords() {
    return m_vTexCoords;
}

std::vector<float> GraphicModelImporter::getNormals() {
    return m_vNormals;
}
